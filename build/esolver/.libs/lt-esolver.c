...
/* esolver/.libs/lt-esolver.c - temporary wrapper executable for .libs/esolver
   Generated by libtool (GNU libtool) 2.5.4

   The esolver/esolver program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/home/mason/Tqsopt-ex/build/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/home/mason/Tqsopt-ex/build/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "esolver"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# esolver/esolver - temporary wrapper script for .libs/esolver\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The esolver/esolver program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libqsopt_ex.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"esolver:esolver/esolver:$LINENO: libtool wrapper (GNU libtool) 2.5.4\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"esolver:esolver/esolver:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"esolver:esolver/esolver:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
  ...
  fputs ("    PATH=/home/mason/Tqsopt-ex/build/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/mason/Tqsopt-ex/build/.libs:$PATH\"\n", f);
  fputs ("\n", f);
