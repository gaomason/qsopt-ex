...
void dbl_ILLutil_dheap_free (
	dbl_ILLdheap * h),
  dbl_ILLutil_dheap_delete (
	dbl_ILLdheap * h,
	int i),
  dbl_ILLutil_dheap_changekey (
	dbl_ILLdheap * h,
	int i,
	double * newkey),
  dbl_ILLutil_dheap_findmin (
	dbl_ILLdheap * h,
	int *i),
  dbl_ILLutil_dheap_deletemin (
	dbl_ILLdheap * h,
	int *i);
...
int dbl_ILLutil_dheap_init (
	dbl_ILLdheap * h,
	int k),
  dbl_ILLutil_dheap_resize (
	dbl_ILLdheap * h,
	int newsize),
  dbl_ILLutil_dheap_insert (
	dbl_ILLdheap * h,
	int i);
