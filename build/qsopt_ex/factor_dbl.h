...
/* RCSINFO $Id: factor_dbl.h,v 1.3 2003/11/05 16:57:39 meven Exp $ */
...
void dbl_ILLfactor_init_factor_work (
	dbl_factor_work * f),
  dbl_ILLfactor_free_factor_work (
	dbl_factor_work * f),
  dbl_ILLfactor_ftran (
	dbl_factor_work * f,
	dbl_svector * a,
	dbl_svector * x),
  dbl_ILLfactor_ftran_update (
	dbl_factor_work * f,
	dbl_svector * a,
	dbl_svector * upd,
	dbl_svector * x),
...
int dbl_ILLfactor_create_factor_work (
	dbl_factor_work * f,
	int dim),
  dbl_ILLfactor_set_factor_iparam (
	dbl_factor_work * f,
	int param,
	int val),
  dbl_ILLfactor_set_factor_dparam (
	dbl_factor_work * f,
	int param,
	double val),
  dbl_ILLfactor (
	...
	int **p_singr,
	int **p_singc),
  dbl_ILLfactor_update (
	dbl_factor_work * f,
	dbl_svector * a,
	int col,
	int *p_refact),
	dbl_ILLfactor_deep_copy (
