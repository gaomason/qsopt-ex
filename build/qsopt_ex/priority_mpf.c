...
void mpf_ILLutil_priority_free (
	mpf_ILLpriority * pri)
{
...
void mpf_ILLutil_priority_findmin (
	mpf_ILLpriority * pri,
	mpf_t * keyval,
	void **en)
{
...
int mpf_ILLutil_priority_insert (
	mpf_ILLpriority * pri,
	void *data,
	mpf_t * keyval,
	int *handle)
{
	...
	if (pri->freelist == -1)
	{
		...
		pri->pri_info =
			EGrealloc (pri->pri_info, sizeof (union mpf_ILLpri_data) * newsize);
		//rval = ILLutil_reallocrus_count ((void **) &pri->pri_info, newsize,
		//                                 sizeof (union mpf_ILLpri_data));
		//ILL_CLEANUP_IF (rval);
...
void mpf_ILLutil_priority_delete (
	mpf_ILLpriority * pri,
	int handle)
{
...
void mpf_ILLutil_priority_deletemin (
	mpf_ILLpriority * pri,
	mpf_t * keyval,
	void **en)
{
...
void mpf_ILLutil_priority_changekey (
	mpf_ILLpriority * pri,
	int handle,
	mpf_t * newkey)
{
