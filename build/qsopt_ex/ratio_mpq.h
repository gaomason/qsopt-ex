...
/*  $RCSfile: ratio_mpq.h,v $ $Revision: 1.3 $ $Date: 2003/11/05 16:57:39 $" */
...
void mpq_ILLratio_pI_test (
	mpq_lpinfo * const lp,
	int const eindex,
	int const dir,
	mpq_ratio_res * const rs),
  mpq_ILLratio_pII_test (
	mpq_lpinfo * const lp,
	int const eindex,
	int const dir,
	mpq_ratio_res * const rs),
