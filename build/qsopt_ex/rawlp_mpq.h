...
/*  RCS_INFO = "$RCSfile: rawlp_mpq.h,v $ $Revision: 1.3 $ $Date: 2003/11/05 16:57:39 $"; */
...
mpq_colptr;
extern mpq_colptr *mpq_ILLcolptralloc (
	ILLptrworld * p);
...
extern void mpq_ILLinit_rawlpdata (
	mpq_rawlpdata * lp,
	mpq_qserror_collector * collector);
extern void mpq_ILLfree_rawlpdata (
	mpq_rawlpdata * lp);
extern void mpq_ILLraw_clear_matrix (
	mpq_rawlpdata * lp);

extern const char *mpq_ILLraw_rowname (
	mpq_rawlpdata * lp,
	int i);
extern const char *mpq_ILLraw_colname (
	mpq_rawlpdata * lp,
	int i);

extern int mpq_ILLraw_add_col (
	mpq_rawlpdata * lp,
	const char *name,
	int intmarker);
extern int mpq_ILLraw_add_row (
	mpq_rawlpdata * lp,
	const char *name,
	int sense,
	const mpq_t rhs);

extern int mpq_ILLraw_add_col_coef (
	mpq_rawlpdata * lp,
	int colind,
	int rowind,
	mpq_t coef);

extern int mpq_ILLraw_init_ranges (
	mpq_rawlpdata * lp);
extern int mpq_ILLraw_init_rhs (
	mpq_rawlpdata * lp);

extern int mpq_ILLraw_add_ranges_coef (
	mpq_rawlpdata * lp,
	int rowind,
	mpq_t coef);


extern int mpq_ILLraw_add_sos (
	mpq_rawlpdata * lp,
	int sos_type);

																								/* add empty set with type */
extern int mpq_ILLraw_add_sos_member (
	mpq_rawlpdata * lp,
	int colind);

																								/* add col to last set */
extern int mpq_ILLraw_is_mem_other_sos (
	mpq_rawlpdata * lp,
	int colind);

extern int mpq_ILLraw_set_rhs_name (
	mpq_rawlpdata * lp,
	const char *name,
	int *skip);
extern int mpq_ILLraw_set_bounds_name (
	mpq_rawlpdata * lp,
	const char *name,
	int *skip);
extern int mpq_ILLraw_set_ranges_name (
	mpq_rawlpdata * lp,
	const char *name,
	int *skip);
extern void mpq_ILLprint_rawlpdata (
	mpq_rawlpdata * lp);

extern char *mpq_ILLraw_unique_name (
	ILLsymboltab * tab,
	char *prefix,
	int i);
extern int mpq_ILLraw_fill_in_rownames (
	mpq_rawlpdata * lp);

extern int mpq_ILLraw_init_bounds (
	mpq_rawlpdata * lp);

extern const char *mpq_ILLraw_set_lowerBound (
	mpq_rawlpdata * lp,
	int i,
	mpq_t bnd);
extern const char *mpq_ILLraw_set_upperBound (
	mpq_rawlpdata * lp,
	int i,
	mpq_t bnd);
extern const char *mpq_ILLraw_set_fixedBound (
	mpq_rawlpdata * lp,
	int i,
	mpq_t bnd);
extern const char *mpq_ILLraw_set_binaryBound (
	mpq_rawlpdata * lp,
	int i);
extern const char *mpq_ILLraw_set_unbound (
	mpq_rawlpdata * lp,
	int colind);
extern int mpq_ILLraw_fill_in_bounds (
	mpq_rawlpdata * lp);

extern int mpq_ILLraw_first_nondefault_bound (
	mpq_ILLlpdata * lp);
extern int mpq_ILLraw_default_lower (
	mpq_ILLlpdata * lp,
	int i);
extern int mpq_ILLraw_default_upper (
	mpq_ILLlpdata * lp,
	int i,
	int ri);

extern int mpq_ILLrawlpdata_to_lpdata (
	mpq_rawlpdata * raw,
	mpq_ILLlpdata * lp);

extern int mpq_ILLdata_error (
	mpq_qserror_collector * collector,
	const char *format,
	...);
extern void mpq_ILLdata_warn (
	mpq_qserror_collector * collector,
	const char *format,
	...);
