...
void mpq_ILLwrite_lp_state_init (
...
void mpq_ILLwrite_lp_state_append (
	mpq_ILLwrite_lp_state * line,
	const char *str)
{
	int len, rval = 0;
...
void mpq_ILLwrite_lp_state_append_coef (
	mpq_ILLwrite_lp_state * line,
	mpq_t v,
	int cnt)
{
...
static void append_number (
	mpq_ILLwrite_lp_state * line,
	mpq_t v);
void mpq_ILLwrite_lp_state_append_number (
	mpq_ILLwrite_lp_state * line,
	mpq_t v)
{
...
void mpq_ILLwrite_lp_state_save_start (
	mpq_ILLwrite_lp_state * line)
{
	line->startlen = line->total;
}

void mpq_ILLwrite_lp_state_start (
	mpq_ILLwrite_lp_state * line)
{
	int j;
