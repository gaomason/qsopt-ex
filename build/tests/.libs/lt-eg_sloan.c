...
/* tests/.libs/lt-eg_sloan.c - temporary wrapper executable for .libs/eg_sloan
   Generated by libtool (GNU libtool) 2.5.4

   The tests/eg_sloan program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "eg_sloan"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tests/eg_sloan - temporary wrapper script for .libs/eg_sloan\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The tests/eg_sloan program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"eg_sloan:tests/eg_sloan:$LINENO: libtool wrapper (GNU libtool) 2.5.4\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"eg_sloan:tests/eg_sloan:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"eg_sloan:tests/eg_sloan:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
