...
/* tests/.libs/lt-test_qs.c - temporary wrapper executable for .libs/test_qs
   Generated by libtool (GNU libtool) 2.5.4

   The tests/test_qs program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_qs"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tests/test_qs - temporary wrapper script for .libs/test_qs\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The tests/test_qs program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test_qs:tests/test_qs:$LINENO: libtool wrapper (GNU libtool) 2.5.4\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_qs:tests/test_qs:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_qs:tests/test_qs:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
